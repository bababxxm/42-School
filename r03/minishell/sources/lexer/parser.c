...
/*   Updated: 2025/12/13 00:12:48 by sklaokli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	check_tokens_2(t_shell *shell, t_token *bef, t_token *cur,
			t_token *aft);
bool	check_tokens_3(t_shell *shell, t_token *bef, t_token *cur,
			t_token *aft);
